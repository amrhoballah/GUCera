...
insert into Student values(@id1,0)
Set @id = @id1
end
go  
...
declare @id1 int
Select @id1 = SCOPE_IDENTITY();
insert into Instructor values(@id1,0)
Set @id = @id1
end
go  
-------------------------------------------------------------
...
Declare @cid1 int
select @cid1 = SCOPE_IDENTITY()
insert into InstructorTeachCourse(cid,insid) values(@cid1,@instructorId)
set @cid = @cid1
...
INSERT INTO Users(firstName,lastName,password,email,gender,address)
VALUES('amr','hoballah','abc','amrualy@gmail.com',1,'nasr city')

INSERT INTO Admin(id)
VALUES(1)

--EXEC InstAddCourse 2,'db3',3600,2
